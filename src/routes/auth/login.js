...
module.exports = async (fastify, opts) => { 
  fastify.post('/login', async (request) => {
    ...
    const { _id, role, username, prefixName, firstName, lastName, profileImage, notices, oldSystemId, isSeenTutorial, isSeenTermAndCondition, isSeenDataPrivacy } = user.toObject()
